  ...
  return (
    <>
      ...
      <div className="relative flex flex-col items-center">
        <div className="static flex flex-col self-auto min-[360px]:w-full md:w-[576px] lg:w-[1024px] h-auto text-white ">
          <Link to="/" className="min-[360px]:mx-[10%] sm:mx-0 md:mx-0 mt-[12px] self-start relative z-101">
            <img
              src={myPhoto}
              className="w-12 h-12"
