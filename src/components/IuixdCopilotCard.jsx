  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center">
        ...
        <p className="text-xs sm:text-sm text-white/80 mt-1 leading-normal font-medium group-hover:text-turquoise-800 transition-colors duration-200">
          Welcome to iuixd Copilot - a synthetic user testing GPT
        </p>
        <div className="text-[11px] sm:text-xs text-white/40 mt-1.5 flex items-center gap-1 font-semibold group-hover:text-turquoise-600 transition-colors duration-200">
          <span>By K K Srikumar</span>
          <span className="text-white/20 group-hover:text-turquoise-300 transition-colors duration-200">•</span>
          <span className="flex items-center gap-1 text-white/60 group-hover:text-turquoise-600 transition-colors duration-200">
